...
#  Plot the com Data
#
def plotpose(commsgs, t0, bagname):
    ...
    axs[0].set(title="Pose Data in '%s'" % bagname)
...
def main():
    ...
    while reader.has_next():
        ...
        if   topic == '/pose':
            posemsgs.append(deserialize_message(rawdata, Point))


    # Process the com number.
    if posemsgs:
        print("Plotting pose data...")
        plotpose(posemsgs, t0, bagname)
    else:
        raise ValueError("No pose data!")
